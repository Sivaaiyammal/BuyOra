...
const Seller = () => {
  const [selectedView, setSelectedView] = useState<'main' | 'create' | 'list'>('main');
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-lg shadow">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 p-6">
          {sellers.map((seller) => (
            <div key={seller.id} className="bg-white rounded-lg border border-gray-200 p-6">
              ...
              <div className="mt-4">
                <p className="text-sm text-gray-600">{seller.company} ({seller.category})</p>
                <p className="text-sm mt-1">Seller ID:- {seller.id}</p>
                <a href={`https://${seller.website}`} className="text-sm text-blue-600 hover:underline block mt-1">{seller.website}</a>
      ...
      <div className="p-6">
        ...
        <form className="space-y-6">
          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="text-center">
                <p className="mb-2 text-sm font-medium text-gray-700">Identity Proof</p>
              ...
              <div className="text-center">
                <p className="mb-2 text-sm font-medium text-gray-700">Address Proof</p>
                <button className="px-4 py-2 bg-white border border-gray-300 rounded-lg text-sm font-medium text-gray-700 hover:bg-gray-50">
                  Upload
                </button>
                <button className="mt-2 px-4 py-2 bg-gray-100 border border-gray-300 rounded-lg text-sm font-medium text-gray-700 hover:bg-gray-200 w-full">
              ...
              <div className="text-center">
                <p className="mb-2 text-sm font-medium text-gray-700">GST Or Business Doc</p>
                <button className="px-4 py-2 bg-white border border-gray-300 rounded-lg text-sm font-medium text-gray-700 hover:bg-gray-50">
                  Upload
                </button>
                <button className="mt-2 px-4 py-2 bg-gray-100 border border-gray-300 rounded-lg text-sm font-medium text-gray-700 hover:bg-gray-200 w-full">
...
const SellerList = () => {
  const sellers = [
    { name: 'yuvaraj', email: 'Validated', aadhaar: 'View file', gst: 'View file', status: 'Approved', date: '1/2/2025' },
    { name: 'Robert', email: 'Validated', aadhaar: 'View file', gst: 'View file', status: 'Approved', date: '12/1/2025' },
    { name: 'Alexander', email: 'Validated', aadhaar: 'View file', gst: 'View file', status: 'Approved', date: '4/4/2025' },
    { name: 'Jon', email: 'Validated', aadhaar: 'View file', gst: 'View file', status: 'Approved', date: '9/2/2024' },
    { name: 'reo', email: 'Validated', aadhaar: 'View file', gst: 'View file', status: 'Approved', date: '5/2/2025' },
    { name: 'max', email: 'Validated', aadhaar: 'View file', gst: 'View file', status: 'Approved', date: '7/2/2025' },
    { name: 'raj kumar', email: 'Validated', aadhaar: 'View file', gst: 'View file', status: 'Approved', date: '5/3/2025' },
    { name: 'krish', email: 'Validated', aadhaar: 'View file', gst: 'View file', status: 'Approved', date: '8/3/25' },
    { name: 'Ronald', email: 'Validated', aadhaar: 'View file', gst: 'View file', status: 'Approved', date: '7/2/2025' },
    { name: 'Elean', email: 'Validated', aadhaar: 'View file', gst: 'View file', status: 'Approved', date: '8/2/2025' }
  ];
