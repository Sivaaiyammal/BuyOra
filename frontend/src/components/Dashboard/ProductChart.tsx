      ...
      <div className="flex justify-center mb-6">
        <div className="relative w-40 h-40">
          <svg width="160" height="160" viewBox="0 0 160 160">
            ...
            <path
              d="M80 80 L160 80 A80 80 0 0 1 80 160 Z"
              fill="#10b981"
            />
            
            {/* Pink slice (Women fashion) - 15% */}
            <path
              d="M80 80 L80 160 A80 80 0 0 1 32 128 Z"
              fill="#ec4899"
            />
            
            {/* Yellow slice (Electrical) - 35% */}
            <path
              d="M80 80 L32 128 A80 80 0 0 1 80 0 Z"
              fill="#f59e0b"
            />
            
            {/* Center white circle with percentage */}
            <circle cx="80" cy="80" r="40" fill="white" />
            <text x="80" y="85" textAnchor="middle" fontSize="18" fontWeight="bold" fill="#374151">50%</text>
          </svg>
        </div>
      </div>
