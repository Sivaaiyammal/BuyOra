...
const notifications = [
  {
    ...
    productDetails: {
      ...
      description:
        "Dress your little one in timeless charm with our Elegant Blue Blossom Party Dress, a perfect blend of sophistication and playful grace."
    }
  },
  {
    id: "2",
                ...
                <div className="p-4 hover:bg-gray-50">
                  <div className="flex items-start justify-between">
                    ...
                    {notification.productDetails && (
                      <button
                        onClick={() =>
                          toggleNotificationDetails(notification.id)
                        }
                        ...
                        <div className="flex gap-4">
                          ...
                          <div>
                            <h5 className="font-semibold">
                              ID: {notification.productDetails.id}
                            </h5>
                            <p className="text-sm mt-1">
                              {notification.productDetails.company}{" "}
                              {notification.productDetails.category}
                            </p>
                            <div className="flex items-center gap-2 mt-1">
                              <a
                                href={`https://${notification.productDetails.website}`}
                                target="_blank"
