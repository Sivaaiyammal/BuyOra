...
const sellerSchema = new mongoose.Schema({
  ...
  identityVerification: { type: String, required: false },
  ...
  gstProof: { type: String, required: true }, 
  bankName: { type: String, required: true },
  accountNumber: { type: String, required: true },
  ifscCode: { type: String, required: true },
  productCategories: [{ type: mongoose.Schema.Types.ObjectId, ref: 'Category', required: true }],
